...
namespace Shadowprofile.HierarchyS
{
    public class FloatingInspectorWindow : EditorWindow
    {
        ...
        private void CreateGUI()
        {
            ...
            var styleSheet = ShadowProfileUtils.GetAssetFromRelativePath<StyleSheet>("HierarchyS/Editor/Layout", "FloatingInspectorWindow");
            if (styleSheet != null)
            {
        ...
        {
            s_CustomIconData = ShadowProfileUtils.GetAssetFromRelativePath<CustomIconData>("HierarchyS/Editor", "CustomIconData");
